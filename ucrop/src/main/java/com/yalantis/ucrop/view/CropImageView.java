...
public class CropImageView extends TransformImageView {
    ...
    public static float SOURCE_IMAGE_ASPECT_RATIO = 0f;
     ...
     */
    public void cropAndSaveImage(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality,ColorFilter colorFilter,
   ...
   //     setImageToWrapCropBounds(false);
        ...
        final ImageState imageState = new ImageState(
                ...
                getCurrentScale(), getCurrentAngle(),colorFilter);

        final CropParameters cropParameters = new CropParameters(
                mMaxResultImageSizeX, mMaxResultImageSizeY,
                compressFormat, compressQuality,
                getImageInputPath(), getImageOutputPath(), getExifInfo(),colorFilter);

        new BitmapCropTask(getViewBitmap(), imageState, cropParameters, cropCallback,colorFilter).execute();
    }
    ...
    public void setCropRect(RectF cropRect) {
        Log.e("CROP", "setCropRect: "+cropRect );
