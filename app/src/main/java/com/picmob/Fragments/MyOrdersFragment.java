...
public class MyOrdersFragment extends Fragment {
    ...
    public void getData() {
        ...
        Call<JsonObject> call = BaseApplication.getInstance().getApiClient().my_order(BaseApplication.getInstance().getSession().getToken(),jsonObject);
                ...
                if (jsonObject != null) {
                    try {
                        ...
                        if (jsonObject1.getString("status").equalsIgnoreCase(Constant.SUCCESS)) {
                            ...
                            myOrderAdapter = new MyOrderAdapter(getActivity(), jsonArray);
